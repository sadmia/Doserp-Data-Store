...
if (isset($_POST['AddBtn'])) {
	...
	<?php } else {
		...
		if ($selectTypeValueInput == "DriverClass1") {
			...
			header("Location: dataView.php?id=".$idDB."&type=".$selectTypeValueInput);
		}
